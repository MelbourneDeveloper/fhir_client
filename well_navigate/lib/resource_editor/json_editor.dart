...
Map<String, TextStyle> getSyntaxTheme({
  ...
  return {
    ...
    'literal': defaultTextStyle.copyWith(color: colorScheme?.primary),
    ...
    'attr': defaultTextStyle.copyWith(color: colorScheme?.error),
    ...
    'string': defaultTextStyle.copyWith(color: colorScheme?.secondaryContainer),
